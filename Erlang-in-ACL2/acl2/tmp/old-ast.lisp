...
;; Erlang patterns do not contain case, if, receive, fun, call, or binops
; (defines pattern
;   :flag-local nil
...
;           (:binop (and (pattern-p (node-binop->left x))
;                            (pattern-p (node-binp->right x))))
;           (:if nil)
;           (:case-of nil)
...
;           (:binop (and (erl-guard-p (node-binop->left x))
;                            (erl-guard-p (node-binop->right x))))
;           (:if nil)
;           (:case-of nil)
;           (:match nil)
;           (:fault t))))
